...
TURBO_MODEM_STATS = os.getenv("TURBO_MODEM_STATS")
...
procs = [
  ...
  PythonProcess("turbo_modem_stats", "openpilot.tools.turbo.modem_stats_logger",
                ugv, enabled=not PC and TURBO_MODEM_STATS is not None, restart_if_crash=True),
