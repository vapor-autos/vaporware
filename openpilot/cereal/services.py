...
_services: dict[str, tuple] = {
  ...
  "turboSteerAssist": (True, 50.),
  "turboSteerAssistState": (True, 20.),
  "turboTeleopCommand": (True, 0.),
  "turboIntentRequest": (True, 10.),
  "turboIntentState": (True, 10.),
  "turboIntentLinkState": (True, 10.),
